...
var school = require('./resources/school.js');
var team = require('./resources/team.js');
var player = require('./resources/player.js');
var events = require('./resources/event.js');
...
swagger
    ...
    .addGet(school.getAllSchools)
    .addGet(school.getSchoolById)
    .addPost(school.addSchool)
    .addPut(school.updateSchool)
    .addDelete(school.deleteSchool)

    .addGet(team.getAllTeams)
    .addGet(team.getTeamById)
    .addPost(team.addTeam)
    .addPut(team.updateTeam)
    .addDelete(team.deleteTeam)

    .addGet(player.getAllPlayers)
    .addGet(player.getPlayerById)
    .addPost(player.addPlayer)
    .addPut(player.updatePlayer)
    .addDelete(player.deletePlayer)

    .addGet(events.getAllEvents)
    .addGet(events.getEventById)
    .addPost(events.addEvent)
    .addPut(events.updateEvent)
    .addDelete(events.deleteEvent)
